...
class MatcherGui:
    ...
    def MakeWidgets(self):
        ...
        # ZZZ For testing only.
        self.entry_1.insert(0, "20028")
        self.entry_2.insert(0, "Lion & Grey Gorilla WIP")
        self.entry_3.insert(0, "20280")
        self.entry_4.insert(0, "Grampy Harold")
...
class NeonMobMatcher:
    ...
    def DoLookup(self, have_setid, have_name, want_setid, want_name):
        ...
        # ZZZ For testing only.  (24 lines x 80 characters)
        if self.grades[0] == 'F':
            self.gui.Print("\nGetting cards from series \"River's Gallery #2\"...\n.\n")
            self.gui.Print("\nGetting seekers of Lion & Grey Gorilla WIP [180280]...\n.\n.\n.\n.\n.\n.\n")
            self.gui.Print("\nGetting cards from series \"Watercolor Birds\"...\n.\n")
            self.gui.Print("\nGetting owners of Grampy Harold [178288]...\n")
            for i in range(25):
                self.gui.Print(".\n")
            self.gui.Print("Joe P (A+)\n")
            self.gui.Print("Needs: \"Lion & Grey Gorilla WIP\" from series \"River's Gallery #2\" (59% core, 25% special)\n")
            self.gui.Print("Has: \"Grampy Harold\" (2 copies) from series \"Watercolor Birds\" (100% core, 100% special)\n\n")
            return
    ...
    def ParseTraders(self, trader_list):
        if trader_list == []:
            self.gui.Print("No matches found.\n")
